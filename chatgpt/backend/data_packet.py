...
class DataPacket():
    ...
    # Dash format (FM)
    _dash_format = _default_format + '17fH6B3b4fi'
    ...
    def _convert(self, key, value):
        ...
        if key == 'speed':
            return round(value * 3.6) # m/s to kph
        elif key == 'power':
        ...
        elif 'tire_temp' in key:
            return round((value - 32)*(5/9), 2) # Convert to C
    ...
    def _get_dash_attributes(self):
        ...
        return [
            ...
            *self._attr_wheel_generator('tire_temp'),
            ...
            # Tire wear
            *self._attr_wheel_generator('tire_wear'),
            # Track ID
            'track_id'
        ]
